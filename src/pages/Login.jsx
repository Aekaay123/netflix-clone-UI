        ...
        <div className="fixed -top-8 w-full px-4 py-24">
          <div className="max-w-[450px] h-[600px] bg-black/80 mx-auto rounded-lg p-10">
            <div className="flex flex-col gap-6 w-full">
              <h1 className="font-nsans-bold text-3xl text-center">Log in</h1>
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <input
                  type="email"
                  className="px-2 py-3 w-full rounded-lg bg-gray-600 focus:outline-none focus:ring focus:border-blue-300"
                  value={email}
                ...
                <div className="mx-auto">
                  ...
                  <Link to={"/signup"} className="inline hover:underline text-white">
                    Sign Up
                  </Link>
                </div>
              </form>
